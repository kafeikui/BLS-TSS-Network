...
contract L2GetRandomNumberLocalTestScript is Script {
    function run() external {
        ...
        // getRandomNumberExample = new GetRandomNumberExample(adapterAddress);
        ...
        // Taiko L2 User Contract Address: 0x2D9DB6d188BF9431458C3c89cbCcb8126820d790
        vm.startBroadcast(userPrivateKey);
        getRandomNumberExample = GetRandomNumberExample(0x2D9DB6d188BF9431458C3c89cbCcb8126820d790);
        getRandomNumberExample.getRandomNumber();
        vm.stopBroadcast();
    }
}
